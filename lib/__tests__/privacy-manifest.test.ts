...
const APPROVED_DATA_TYPES: Record<string, [boolean, boolean, string[]]> = {
  ...
  NSPrivacyCollectedDataTypeProductInteraction: [true, false, ['NSPrivacyCollectedDataTypePurposeAnalytics']],
  NSPrivacyCollectedDataTypeCrashData: [false, false, ['NSPrivacyCollectedDataTypePurposeAppFunctionality']],
  NSPrivacyCollectedDataTypePerformanceData: [false, false, ['NSPrivacyCollectedDataTypePurposeAppFunctionality']],
...
describe('the generated manifest is deterministic and duplicate-free', () => {
  ...
  test('a clean checkout (no existing file) produces every declaration', () => {
    ...
    expect(generated.NSPrivacyCollectedDataTypes).toHaveLength(11);

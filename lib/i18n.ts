...
const en = {
  ...
  profile: {
    ...
    // Blocking failure state, not a toast. A destructive action that did NOT
    // happen must say so unambiguously, and must say what is still true.
    deleteFailedTitle: 'Your account was not deleted',
    deleteFailedBody: 'Something went wrong and your account still exists. You are still signed in and none of your data has been removed. You can try again, or contact us if this keeps happening.',
    deleteFailedRetry: 'Try again',
    deleteFailedSupport: 'Contact support',
    deleteFailedDismiss: 'Not now',
    // STATE C — the account IS deleted. This must never read as a failed
    // deletion; it reports only that this device was not fully tidied up.
    deleteCleanupTitle: 'Account deleted',
    deleteCleanupBody: 'Your account has been deleted. Some GutWell data stored on this device could not be cleared. Please restart GutWell — if you can still see any of your old data afterwards, contact us and we’ll sort it out.',
    deleteCleanupSupport: 'Contact support',
    deleteCleanupDismiss: 'OK',
  ...
  sources: {
    ...
    intro:
      'GutWell AI is a wellness tracking app, not a medical device. This page separates two different things: general health information that comes from outside sources, and the parts of GutWell we built ourselves.',

    // ── A. External sources ───────────────────────────────────────────────
    sourcesHeading: 'Sources',
    sourcesIntro:
      'General health information in GutWell draws on the references below. They are listed so you can read the original yourself. Links open outside the app, and the sources are in English.',
    categoryNames: {
      stool_form: 'Stool form',
      fermentable_carbs: 'Fermentable carbohydrates and bloating',
      reflux_and_timing: 'Reflux, meal size and timing',
      activity_and_digestion: 'Activity after eating',
      diet_diversity: 'Variety in what you eat',
      sleep: 'Sleep',
      gut_brain_axis: 'The gut–brain axis',
      general_wellness: 'General digestive wellness',
    },

    // ── B. Methodology (proprietary — deliberately NOT cited) ─────────────
    methodologyHeading: 'How GutWell works',
    methodologyIntro:
      'These are ours. They are not taken from published research, so they carry no citation — claiming one would be misleading. Here is what each is and what it is not.',

    gutScoreTitle: 'GutWell Score',
    gutScoreBody:
      'A number from 0 to 100 calculated from your own daily check-ins — stool form, bloating, pain, energy, mood, the symptoms you logged, and how consistently you have checked in. Its purpose is to let you compare your own days with each other over time. It is relative to you and means nothing compared with anyone else. It is a proprietary reflection score: not medically validated, not diagnostic, and not a measure of health.',

    mealScoreTitle: 'Meal Impact Score',
    mealScoreBody:
      'A number from 1 to 10 generated by AI from the meal you shared and the context you gave it — how you felt, the time of day, what you planned to do next. It is a reflection on how a meal might fit that moment, not a measurement, not a prediction, and not a nutritional rating. AI can be wrong, which is why you can correct it with Refine Analysis.',

    patternsTitle: 'Possible Patterns and Well-Tolerated Foods',
    patternsBody:
      'Associations surfaced by comparing foods in your own history against symptoms you logged afterwards. They describe what appeared together in your entries — they are observations for reflection, never proof that one thing caused the other. Many things affect how you feel, and GutWell only sees what you record. This is why patterns are labelled early, possible or stronger, and never as a verdict about a food.',

    aiTitle: 'AI-generated analysis',
    aiBody:
      'Meal analysis and its suggestions are written by an AI model from what you provide. It is instructed to use cautious language and never to diagnose, treat or promise an outcome. It does not cite sources, because a model asked for citations will invent them — the references on this page are chosen and checked by a person instead.',

    // ── Closing ───────────────────────────────────────────────────────────
    disclaimerHeading: 'Important',
    disclaimerBody:
      'GutWell AI does not diagnose, treat, cure or prevent any condition. It is not a substitute for professional medical advice. Always consult a qualified healthcare professional with any question about a medical condition, and never delay seeking advice because of something you read here.',
    openLink: 'Open source',
    // Context-specific entry labels. All five open the same screen; the wording
    // tells the user what they will find, so the citation is easy to locate
    // from wherever the health information is shown.
    linkBristol: 'About the Bristol Stool Scale',
    linkScore: 'How this score works',
    linkAnalysis: 'Sources & methodology',
    linkPatterns: 'How patterns are identified',
    linkProfile: 'Sources & methodology',
  },
  paywall: {
    title: 'GutWell AI',
  ...
  home: {
    ...
    scanSubtitle: 'Snap a photo — get insights about your meal in seconds',
  ...
  progress: {
    ...
    labelMeals: 'Meals',
    gutScoreTrend: 'GutWell Score Trend',
  ...
  photoAnalysis: {
    ...
    // Reads as one sentence with profileContextScore and the 0-100 value:
    // "Your recent GutWell Score: 42/100". No condition label follows it.
    profileContextPrefix: 'Your recent ',
    profileContextEmpty: 'General gut guidance — complete check-ins to personalise',
    profileContextScore: 'GutWell Score:',
...
const de: Translations = {
  ...
  profile: {
    ...
    deleteFailedTitle: 'Dein Konto wurde nicht gelöscht',
    deleteFailedBody: 'Etwas ist schiefgelaufen und dein Konto besteht weiterhin. Du bist weiterhin angemeldet und es wurden keine Daten entfernt. Du kannst es erneut versuchen oder uns kontaktieren, falls das öfter passiert.',
    deleteFailedRetry: 'Erneut versuchen',
    deleteFailedSupport: 'Support kontaktieren',
    deleteFailedDismiss: 'Jetzt nicht',
    deleteCleanupTitle: 'Konto gelöscht',
    deleteCleanupBody: 'Dein Konto wurde gelöscht. Einige auf diesem Gerät gespeicherte GutWell-Daten konnten nicht entfernt werden. Bitte starte GutWell neu — wenn danach noch alte Daten sichtbar sind, melde dich bei uns.',
    deleteCleanupSupport: 'Support kontaktieren',
    deleteCleanupDismiss: 'OK',
  ...
  sources: {
    ...
    intro:
      'GutWell AI ist eine App zur Wellness-Erfassung, kein Medizinprodukt. Diese Seite trennt zwei Dinge: allgemeine Gesundheitsinformationen aus externen Quellen und die Teile von GutWell, die wir selbst entwickelt haben.',

    sourcesHeading: 'Quellen',
    sourcesIntro:
      'Allgemeine Gesundheitsinformationen in GutWell stützen sich auf die folgenden Referenzen. Sie sind aufgeführt, damit du das Original selbst nachlesen kannst. Links öffnen sich außerhalb der App, die Quellen sind auf Englisch.',
    categoryNames: {
      stool_form: 'Stuhlform',
      fermentable_carbs: 'Fermentierbare Kohlenhydrate und Blähbauch',
      reflux_and_timing: 'Reflux, Portionsgröße und Zeitpunkt',
      activity_and_digestion: 'Aktivität nach dem Essen',
      diet_diversity: 'Vielfalt beim Essen',
      sleep: 'Schlaf',
      gut_brain_axis: 'Die Darm-Hirn-Achse',
      general_wellness: 'Allgemeines Wohlbefinden der Verdauung',
    },

    methodologyHeading: 'So funktioniert GutWell',
    methodologyIntro:
      'Diese Teile stammen von uns. Sie basieren nicht auf veröffentlichter Forschung und tragen deshalb bewusst keine Quellenangabe — eine anzugeben wäre irreführend. Hier steht, was sie sind und was nicht.',

    gutScoreTitle: 'GutWell-Score',
    gutScoreBody:
      'Eine Zahl von 0 bis 100, berechnet aus deinen eigenen täglichen Check-ins — Stuhlform, Blähbauch, Schmerzen, Energie, Stimmung, erfasste Symptome und wie regelmäßig du einträgst. Der Zweck ist, deine eigenen Tage über die Zeit miteinander zu vergleichen. Der Wert ist relativ zu dir und sagt im Vergleich zu anderen Menschen nichts aus. Es ist ein eigener Reflexionswert: nicht medizinisch validiert, nicht diagnostisch und kein Maß für Gesundheit.',

    mealScoreTitle: 'Mahlzeiten-Impact-Score',
    mealScoreBody:
      'Eine Zahl von 1 bis 10, von einer KI erzeugt aus der Mahlzeit und dem Kontext, den du angibst — wie du dich fühlst, die Tageszeit, was du als Nächstes vorhast. Es ist eine Einordnung, wie eine Mahlzeit zu diesem Moment passen könnte — keine Messung, keine Vorhersage und keine Nährwertbewertung. KI kann sich irren; deshalb kannst du sie mit „Analyse verfeinern“ korrigieren.',

    patternsTitle: 'Mögliche Muster und gut verträgliche Lebensmittel',
    patternsBody:
      'Zusammenhänge, die entstehen, wenn Lebensmittel aus deiner eigenen Historie mit danach erfassten Symptomen verglichen werden. Sie beschreiben, was in deinen Einträgen gemeinsam auftrat — sie sind Beobachtungen zum Nachdenken, nie ein Beweis dafür, dass eines das andere verursacht hat. Vieles beeinflusst dein Befinden, und GutWell sieht nur, was du erfasst. Deshalb heißen Muster früh, möglich oder deutlicher — nie ein Urteil über ein Lebensmittel.',

    aiTitle: 'KI-generierte Analyse',
    aiBody:
      'Die Mahlzeitenanalyse und ihre Hinweise werden von einem KI-Modell aus deinen Angaben verfasst. Es ist angewiesen, vorsichtige Sprache zu verwenden und niemals zu diagnostizieren, zu behandeln oder ein Ergebnis zu versprechen. Es gibt keine Quellen an, denn ein Modell, das um Quellen gebeten wird, erfindet sie — die Referenzen auf dieser Seite werden stattdessen von einem Menschen ausgewählt und geprüft.',

    disclaimerHeading: 'Wichtig',
    disclaimerBody:
      'GutWell AI ist nicht dazu bestimmt, Krankheiten zu diagnostizieren, zu behandeln, zu heilen oder ihnen vorzubeugen. Die App ersetzt keine professionelle medizinische Beratung. Wende dich bei Fragen zu einer Erkrankung immer an qualifiziertes medizinisches Fachpersonal und zögere nie, ärztlichen Rat einzuholen.',
    openLink: 'Quelle öffnen',
    linkBristol: 'Über die Bristol-Stuhlformskala',
    linkScore: 'So funktioniert dieser Score',
    linkAnalysis: 'Quellen & Methodik',
    linkPatterns: 'So werden Muster erkannt',
    linkProfile: 'Quellen & Methodik',
  },
  paywall: {
    title: 'GutWell AI',
  ...
  photoAnalysis: {
    ...
    profileContextPrefix: 'Dein letzter ',

...
function buildMealTextOnlyPrompt(body: MealTextBody & { mealDescription?: string }): string {
  ...
  return [
    ...
    "- A condition label such as IBS is context for relevance and tone only: it never licenses an elimination diet, a named clinical programme, or an instruction to remove a food group. Where a meaningful dietary change seems relevant, say that a doctor or registered dietitian is the right person to plan it.",

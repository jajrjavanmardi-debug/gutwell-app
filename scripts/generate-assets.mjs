...
const ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="1024" height="1024">
  ...
  <!-- Gut wave below leaf -->
  <path d="M380 790 C420 750 460 830 500 790 C540 750 580 830 620 790 C660 750 690 790 710 790" stroke="#52B788" stroke-width="28" stroke-linecap="round" fill="none"/>
</svg>`;
...
const SPLASH_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1284 2778" width="1284" height="2778">
  <!-- Background -->
  <rect width="1284" height="2778" fill="#FAFDF7"/>
  <!-- Subtle radial glow behind icon -->
  <radialGradient id="glow" cx="50%" cy="39.2%" r="22%" fx="50%" fy="39.2%">
    <stop offset="0%" stop-color="#D8EFDF" stop-opacity="1"/>
    <stop offset="100%" stop-color="#FAFDF7" stop-opacity="0"/>
  </radialGradient>
  <rect width="1284" height="2778" fill="url(#glow)"/>
  <!-- Icon card: centered, 300×300 -->
  <g transform="translate(492, 1089)">
    <rect width="300" height="300" rx="68" fill="#1B4332"/>
    <!-- Leaf -->
    ...
    <!-- Gut wave -->
    <path d="M111 230 C123 219 134 242 146 230 C158 219 170 242 182 230 C193 219 202 230 208 230" stroke="#52B788" stroke-width="8" stroke-linecap="round" fill="none"/>
  </g>
  <!-- App name -->
  <text x="642" y="1460" font-family="Georgia, serif" font-size="72" font-weight="bold" fill="#1B4332" text-anchor="middle">GutWell</text>
  <!-- Tagline -->
  <text x="642" y="1520" font-family="Arial, sans-serif" font-size="32" fill="#6B9E7A" text-anchor="middle">Track. Understand. Thrive.</text>
  <!-- Decorative dots below tagline -->
  <circle cx="622" cy="1570" r="5" fill="#52B788" opacity="0.4"/>
  <circle cx="642" cy="1570" r="5" fill="#52B788" opacity="0.6"/>
  <circle cx="662" cy="1570" r="5" fill="#52B788" opacity="0.4"/>
</svg>`;
...
async function generateSplashIcon() {
  ...
  const splashIconSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="200" height="200">
    <rect width="200" height="200" rx="44" fill="#1B4332"/>
    ...
    <path d="M74 155 C80 149 87 160 93 154 C99 149 106 160 112 154 C118 149 123 154 126 154" stroke="#52B788" stroke-width="6" stroke-linecap="round" fill="none"/>
  </svg>`;
...
async function generateFavicon() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 196 196" width="196" height="196">
    <rect width="196" height="196" rx="42" fill="#1B4332"/>
    ...
    <path d="M72 150 C77 144 84 154 90 148 C96 143 102 154 108 148 C114 143 119 148 122 148" stroke="#52B788" stroke-width="5.5" stroke-linecap="round" fill="none"/>
  </svg>`;

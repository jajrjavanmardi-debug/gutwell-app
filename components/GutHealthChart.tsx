...
const CHART_COPY: Record<AppLanguage, {
  ...
  en: {
    ...
    score: 'Avg estimate',
    date: 'Date',
    empty: 'No meal estimates logged in the last 14 days.',
    caption: 'Shows daily average wellness estimates from meal insights over the last 14 days.',
  },
  de: {
    kicker: 'Tagesdurchschnitt',
    title: 'Darmwohlbefinden-Trend',
    pill: 'Letzte 14 Tage',
    score: 'Ø Einschätzung',
    date: 'Datum',
    empty: 'Keine Mahlzeiten-Einschätzungen in den letzten 14 Tagen.',
    caption: 'Zeigt den täglichen Durchschnitt deiner Wellness-Einschätzungen aus Mahlzeiten-Einblicken der letzten 14 Tage.',
  },
  fa: {
    kicker: 'میانگین روزانه',
    title: 'روند تندرستی گوارش',
    pill: '۱۴ روز گذشته',
    score: 'میانگین برآورد',
    date: 'تاریخ',
    empty: 'در ۱۴ روز گذشته برآورد غذایی ثبت نشده است.',
    caption: 'میانگین روزانه برآوردهای تندرستی از بینش‌های غذایی ۱۴ روز گذشته را نشان می‌دهد.',
  },
};

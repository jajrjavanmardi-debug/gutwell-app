...
const SETTINGS_COPY = {
  en: {
    ...
    shareMessage: [
      ...
      '3. Test onboarding, language switching, meal photo/sample analysis, SOS relief, history, and settings.',
      '',
      'Feedback request:',
  ...
  de: {
    ...
    medicalConditions: 'Gesundheitliche Angaben',
    medicalConditionsHint: 'Wähle alles aus, was zutrifft. Die Mahlzeitenanalyse nutzt diese Angaben.',
    language: 'Sprache',
    ...
    shareMessage: [
      'NutriFlow',
      '',
      'Eine mobile App für Darmgesundheit mit Mahlzeiten-Fotoanalyse, symptombezogenem Gut Score, schneller SOS-Hilfe und täglichen Verlaufsdaten.',
      '',
      ...
      '3. Teste Onboarding, Sprachwechsel, Foto-/Beispielanalyse, SOS-Hilfe, Verlauf und Einstellungen.',
      '',
      'Feedback-Wunsch:',
  ...
  fa: {
    ...
    settings: 'تنظیمات',
    medicalConditions: 'اطلاعات سلامت',
    medicalConditionsHint: 'موارد مرتبط را انتخاب کنید. تحلیل وعده‌ها از این اطلاعات استفاده می‌کند.',
    language: 'زبان',
    languageHint: 'زبان برنامه را انتخاب کنید. فارسی با چیدمان راست‌به‌چپ نمایش داده می‌شود.',
    aiPersonalization: 'شخصی‌سازی هوشمند',
    ...
    shareMessage: [
      'NutriFlow',
      '',
      'یک اپلیکیشن موبایل برای سلامت گوارش با تحلیل عکس غذا، Gut Score بر اساس علائم، راهنمای فوری SOS و روند روزانه سوابق غذایی.',
      '',
      ...
      '۳. شروع اولیه، تغییر زبان، تحلیل عکس یا غذای نمونه، SOS، سوابق و تنظیمات را آزمایش کنید.',
      '',
      'درخواست بازخورد:',

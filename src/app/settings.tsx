...
const SETTINGS_COPY = {
  ...
  de: {
    ...
    shareFeedbackHint: 'Lade Tester ein, NutriFlow zu testen und praktisches Feedback zu senden.',
  ...
  fa: {
    ...
    shareFeedbackHint: 'یک تستر را دعوت کنید تا NutriFlow را پیش نمایش کند و بازخورد کاربردی بدهد.',
    ...
    shareMessage: [
      ...
      '۱. لینک فعلی پیش نمایش برنامه را باز کنید یا QR code پیش نمایش را اسکن کنید.',
      '۲. به عنوان مهمان ادامه دهید یا با حساب تست وارد شوید.',
      '۳. آنبوردینگ، تغییر زبان، تحلیل عکس یا غذای نمونه، SOS، سوابق و تنظیمات را تست کنید.',
      '',
      'درخواست بازخورد:',

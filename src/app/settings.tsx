...
const SETTINGS_COPY = {
  en: {
    ...
    shareMessage: [
      'NutriFlow',
      '',
      'A mobile gut wellness companion for meal photo insights, symptom-aware Gut Scores, quick comfort tips, and food-history pattern tracking.',
      '',
  ...
  de: {
    ...
    shareMessage: [
      'NutriFlow',
      '',
      'Eine mobile App für Darmwohlbefinden mit Mahlzeiten-Einblicken, symptombezogenem Gut Score, sanfter SOS-Unterstützung und Musterverlauf.',
      '',
      ...
      '',
      'Feedback-Wunsch:',
      'Bitte teile, was unklar wirkt, was bereits präsentationsreif ist, ob etwas abstürzt oder langsam lädt und ob Gut Score und Ergebnisse hilfreich sind.',
    ].join('\n'),
  },
  fa: {
    ...
    shareMessage: [
      'NutriFlow',
      '',
      'یک اپلیکیشن موبایل برای تندرستی گوارش با بینش عکس غذا، Gut Score بر اساس علائم، پشتیبانی ملایم SOS و پیگیری الگوهای غذایی.',
      '',
      ...
      '',
      'درخواست بازخورد:',
      'لطفاً بگویید کدام بخش‌ها نامفهوم است، چه چیزهایی برای دمو آماده به نظر می‌رسد، آیا خطا یا کندی وجود دارد و آیا Gut Score و نتایج برای شما مفید هستند.',
    ].join('\n'),
  },
} as const;

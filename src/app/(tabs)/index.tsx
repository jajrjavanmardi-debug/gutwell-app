...
const UI_COPY = {
  en: {
    analysis: 'Analysis',
    history: 'History',
    quickTips: 'Comfort Tips',
    welcomeMessageTitle: "How's your gut today?",
    welcomeMessageSubtitle:
      'Share your energy, digestion, cravings, or symptoms. NutriFlow turns trusted food data into educational, pattern-aware nutrition ideas.',
  ...
  de: {
    ...
    welcomeMessageTitle: 'Wie fühlt sich dein Bauch heute an?',
    welcomeMessageSubtitle:
      'Teile Energie, Verdauung, Heißhunger oder Symptome. NutriFlow macht daraus eine konkrete, sanfte Ernährungsidee.',
  ...
  fa: {
    analysis: 'تحلیل',
    history: 'سوابق',
    quickTips: 'نکات آرام‌سازی',
    welcomeMessageTitle: 'امروز حال گوارش شما چطور است؟',
    welcomeMessageSubtitle:
      'انرژی، هضم، میل غذایی یا علائم خود را بنویسید تا NutriFlow یک پیشنهاد تغذیه‌ای ملایم و کاربردی ارائه کند.',
    startScan: 'شروع تحلیل',
...
const translations = {
  en: {
    ...
    conditions: 'Profile Context',
    activity: 'Activity Level',
    button: 'Get educational insight',
    photoAnalysisButton: 'Photo meal insight',
    placeholder: 'Tell me what you ate or how you feel...',
    clear: 'Clear',
    loading: 'Preparing educational insight from nutrients and food data...',
    preparingHealthBuddy: 'Preparing your NutriFlow insight...',
    recommendationReady: 'Insight ready',
    reanalyzeMessage: 'Please re-analyze to see results in English.',
    emptyAlertTitle: 'How are you feeling?',
    emptyAlertMessage: 'Please describe how you are feeling before generating an educational insight.',
    errorTitle: 'Insight failed',
    genericErrorMessage: 'Something went wrong while generating your insight.',
    ...
    supportiveNutrients: 'Nutrients to consider',
    nutrientBadges: 'Nutrient Badges',
    usdaMatches: 'USDA matches',
    recommendedFoods: 'Food ideas',
    noFoods: 'No USDA foods matched yet, but your educational insight is ready.',
    yourPlan: 'Your plan',
    bigRecommendation: 'Main insight',
    photoHistoryTitle: 'Recent History',
    photoHistorySubtitle: 'Meal insights from the last 14 days',
    photoHistoryEmpty: 'No meal photo insights yet.',
    photoHistoryNoScore: 'Estimate pending',
    historyButton: 'View full history',
    heatmapTitle: 'Recent meal scans',
    heatmapSubtitle: 'Last 30 days',
    progressChartTitle: '7-day body rhythm',
    progressChartSubtitle: 'Wellness estimate and energy',
    gutScoreMetric: 'Wellness estimate',
    energyMetric: 'Energy',
    xpLabel: 'awareness points',
    nextRank: 'Next step',
    rankUp: 'Progress noted',
    goodFeelingCelebration: 'Comfort note saved',
    chartPopupDate: 'Date',
    chartPopupScore: 'Estimate',
    ...
    scoreDecrease: 'Decrease wellness estimate',
    scoreIncrease: 'Increase wellness estimate',
    languageButtons: {
      en: 'EN',
      de: 'DE',
      fa: 'FA',
    },
    welcomeEmptyTitle: 'Tell me how you feel to start pattern tracking.',
    welcomeEmptyText:
      'NutriFlow will turn your check-in into nutrients to consider, food ideas, and one gentle next step.',
    diseases: {
      ibs: 'IBS',
      gastritis: 'Gastritis',
      bloating: 'Bloating',
  ...
  de: {
    appEyebrow: 'NutriFlow Ernährungscoach',
    welcome: 'Wie fühlt sich dein Bauch heute an?',
    heroSubtitle:
      'Teile Energie, Verdauung, Heißhunger oder Symptome. NutriFlow macht daraus eine konkrete, sanfte Ernährungsidee.',
    inputLabel: 'Was ist gerade los?',
    score: 'Tägliche Wellness-Einschätzung: ',
    scoreHelper:
    ...
    dailyGutScore: 'Tägliche Wellness-Einschätzung',
    noScoreYet: 'Noch keine Einschätzung',
    ...
    conditions: 'Profilkontext',
    activity: 'Aktivität',
    button: 'Orientierenden Einblick erstellen',
    photoAnalysisButton: 'Foto-Einblick für Mahlzeiten',
    placeholder: 'Was hast du gegessen oder wie fühlst du dich?',
    clear: 'Löschen',
    loading: 'Orientierender Einblick aus Nährstoffen und Lebensmitteldaten wird vorbereitet…',
    preparingHealthBuddy: 'NutriFlow bereitet deinen Einblick vor…',
    recommendationReady: 'Einblick ist bereit',
    ...
    genericErrorMessage: 'Beim Erstellen deines Einblicks ist etwas schiefgelaufen.',
    ...
    supportiveNutrients: 'Nährstoffe zum Beobachten',
    nutrientBadges: 'Nährstoff-Highlights',
    usdaMatches: 'Datenabgleich',
    recommendedFoods: 'Lebensmittelideen',
    noFoods: 'Noch keine passenden Lebensmitteldaten gefunden – dein Einblick ist trotzdem bereit.',
    yourPlan: 'Dein Plan',
    bigRecommendation: 'Wichtigster Einblick',
    photoHistoryTitle: 'Aktueller Verlauf',
    photoHistorySubtitle: 'Mahlzeiten-Einblicke der letzten 14 Tage',
    photoHistoryEmpty: 'Noch keine Foto-Einblicke zu Mahlzeiten.',
    photoHistoryNoScore: 'Einschätzung folgt',
    historyButton: 'Vollständigen Verlauf ansehen',
    heatmapTitle: 'Letzte Mahlzeitenanalysen',
    heatmapSubtitle: 'Letzte 30 Tage',
    progressChartTitle: '7-Tage-Rhythmus',
    progressChartSubtitle: 'Wellness-Einschätzung und Energie',
    gutScoreMetric: 'Wellness-Einschätzung',
    energyMetric: 'Energie',
    xpLabel: 'Beobachtungspunkte',
    nextRank: 'Nächster Schritt',
    rankUp: 'Fortschritt notiert',
    goodFeelingCelebration: 'Befinden notiert',
    chartPopupDate: 'Datum',
    chartPopupScore: 'Einschätzung',
    ...
    supplementNamePlaceholder: 'Supplement, z. B. Probiotikum',
    ...
    scoreDecrease: 'Wellness-Einschätzung verringern',
    scoreIncrease: 'Wellness-Einschätzung erhöhen',
    languageButtons: {
      en: 'EN',
      de: 'DE',
      fa: 'FA',
    },
    welcomeEmptyTitle: 'Erzähl kurz, wie es dir geht.',
    welcomeEmptyText:
      'NutriFlow macht aus deinem Check-in Nährstoffe zum Beobachten und einen sanften nächsten Schritt.',
    diseases: {
      ibs: 'Reizdarmsyndrom',
      gastritis: 'Gastritis',
      bloating: 'Blähungen',
  ...
  fa: {
    ...
    heroSubtitle:
      'انرژی، هضم، میل غذایی یا علائم خود را بنویسید. NutriFlow بر اساس آن یک پیشنهاد تغذیه‌ای ملایم و کاربردی ارائه می‌کند.',
    inputLabel: 'شرح حال خود را بنویسید',
    score: 'برآورد روزانه تندرستی: ',
    scoreHelper:
    ...
    dailyGutScore: 'برآورد روزانه تندرستی',
    noScoreYet: 'هنوز برآوردی نیست',
    ...
    conditions: 'زمینه پروفایل',
    activity: 'سطح فعالیت',
    button: 'دریافت بینش آموزشی',
    photoAnalysisButton: 'بینش عکس غذا',
    placeholder: 'بنویسید چه خورده‌اید یا چه احساسی دارید…',
    clear: 'پاک‌کردن',
    loading: 'در حال آماده‌سازی بینش آموزشی از مواد مغذی و داده‌های غذایی…',
    preparingHealthBuddy: 'NutriFlow در حال آماده‌سازی بینش شماست…',
    recommendationReady: 'بینش آماده است',
    reanalyzeMessage: 'برای دیدن نتیجه به فارسی، لطفاً دوباره تحلیل کنید.',
    emptyAlertTitle: 'چه احساسی دارید؟',
    emptyAlertMessage: 'قبل از ساخت بینش آموزشی، لطفاً حال خود را توضیح دهید.',
    errorTitle: 'ساخت بینش ناموفق بود',
    genericErrorMessage: 'هنگام ساخت بینش مشکلی پیش آمد.',
    ...
    supportiveNutrients: 'مواد مغذی قابل توجه',
    nutrientBadges: 'نشان‌های مواد مغذی',
    usdaMatches: 'داده‌های غذایی',
    recommendedFoods: 'ایده‌های غذایی',
    noFoods: 'هنوز داده غذایی دقیقی پیدا نشد، اما بینش آموزشی آماده است.',
    yourPlan: 'برنامه شما',
    bigRecommendation: 'بینش اصلی',
    photoHistoryTitle: 'سوابق اخیر',
    photoHistorySubtitle: 'بینش‌های غذایی در ۱۴ روز گذشته',
    photoHistoryEmpty: 'هنوز بینش عکس غذا ندارید.',
    photoHistoryNoScore: 'برآورد در انتظار',
    historyButton: 'مشاهده همه سوابق',
    heatmapTitle: 'تحلیل‌های اخیر غذا',
    heatmapSubtitle: '۳۰ روز گذشته',
    progressChartTitle: 'روند ۷ روزه بدن',
    progressChartSubtitle: 'برآورد تندرستی و انرژی',
    gutScoreMetric: 'برآورد تندرستی',
    energyMetric: 'انرژی',
    xpLabel: 'امتیاز آگاهی',
    nextRank: 'گام بعدی',
    rankUp: 'پیشرفت ثبت شد',
    goodFeelingCelebration: 'یادداشت احساس ثبت شد',
    chartPopupDate: 'تاریخ',
    chartPopupScore: 'برآورد',
    ...
    scoreDecrease: 'کاهش برآورد تندرستی',
    scoreIncrease: 'افزایش برآورد تندرستی',
    languageButtons: {
      en: 'EN',
      de: 'DE',
      fa: 'FA',
    },
    welcomeEmptyTitle: 'برای شروع، حال خود را کوتاه بنویسید.',
    welcomeEmptyText:
      'NutriFlow چک‌این شما را به مواد مغذی قابل توجه و یک قدم بعدی ملایم تبدیل می‌کند.',
    diseases: {
...
const SCIENTIFIC_SOURCE_COPY: Record<Language, string> = {
  en: 'Data Source: USDA FoodData Central & localized AI adaptation.',
  de: 'Datenquelle: USDA FoodData Central & lokalisierte KI-Anpassung.',
  fa: 'منبع داده: USDA FoodData Central و سازگاری محلی با هوش مصنوعی.',
};
          ...
          >
            ...
            {rankUpBadge ? (
              <View style={[styles.rankUpBadge, isRtl && styles.rtlRow]}>
                <Ionicons name="checkmark-circle" size={15} color="#000000" />

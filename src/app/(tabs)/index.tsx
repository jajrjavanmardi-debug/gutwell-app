...
const translations = {
  ...
  de: {
    ...
    activity: 'Aktivität',
    button: 'Bildenden Einblick erstellen',
    photoAnalysisButton: 'Foto-Einblick für Mahlzeiten',
    placeholder: 'Was hast du gegessen oder wie fühlst du dich?',
    clear: 'Löschen',
    loading: 'Bildender Einblick aus Nährstoffen und Lebensmitteldaten wird vorbereitet…',
    ...
    photoHistoryNoScore: 'Score folgt',
    ...
    progressChartSubtitle: 'Darm-Score und Energie',
  ...
  fa: {
    ...
    dailyGutScore: 'امتیاز روزانه گوارش',
    ...
    progressChartSubtitle: 'امتیاز گوارش و سطح انرژی',
    gutScoreMetric: 'امتیاز گوارش',
    energyMetric: 'انرژی',
    ...
    scoreDecrease: 'کاهش امتیاز گوارش',
    scoreIncrease: 'افزایش امتیاز گوارش',
    languageButtons: {
      en: 'EN',
      de: 'DE',
      fa: 'FA',

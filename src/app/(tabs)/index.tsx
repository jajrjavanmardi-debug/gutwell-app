...
const translations = {
  en: {
    ...
    progressChartSubtitle: 'Wellness estimate + energy level',
  ...
  de: {
    ...
    rankUp: 'Level erreicht',
    goodFeelingCelebration: 'Gutes Gefühl gespeichert',
  ...
  fa: {
    ...
    heatmapTitle: 'زنجیره تحلیل غذا',
    heatmapSubtitle: '۳۰ روز گذشته',
    progressChartTitle: 'روند ۷ روزه بدن',
    progressChartSubtitle: 'برآورد تندرستی و سطح انرژی',

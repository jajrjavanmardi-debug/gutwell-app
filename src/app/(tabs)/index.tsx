...
const translations = {
  ...
  de: {
    ...
    conditions: 'Gesundheitliche Angaben',
    activity: 'Aktivität',
    button: 'Freundliche Empfehlung erstellen',
    photoAnalysisButton: 'Fotoanalyse für Mahlzeiten',
    placeholder: 'Was hast du gegessen oder wie fühlst du dich?',
    clear: 'Löschen',
    loading: 'Nährstoffe und Lebensmitteldaten werden ausgewertet…',
    preparingHealthBuddy: 'NutriFlow bereitet deine Empfehlung vor…',
    ...
    noFoods: 'Noch keine passenden Lebensmitteldaten gefunden – deine Empfehlung ist trotzdem bereit.',
    yourPlan: 'Dein Plan',
    bigRecommendation: 'Wichtigste Empfehlung',
    photoHistoryTitle: 'Aktueller Verlauf',
    photoHistorySubtitle: 'Mahlzeitenanalysen der letzten 14 Tage',
    ...
    welcomeEmptyText:
      'NutriFlow macht aus deinem Check-in unterstützende Nährstoffe und einen konkreten nächsten Schritt.',
    diseases: {
      ibs: 'Reizdarmsyndrom',
      gastritis: 'Gastritis',
      bloating: 'Blähungen',
  ...
  fa: {
    ...
    conditions: 'اطلاعات سلامت',
    activity: 'سطح فعالیت',
    button: 'دریافت پیشنهاد دوستانه',
    photoAnalysisButton: 'تحلیل عکس غذا',
    placeholder: 'بنویسید چه خورده‌اید یا چه احساسی دارید…',
    clear: 'پاک‌کردن',
    loading: 'در حال تحلیل مواد مغذی و داده‌های غذایی…',
    preparingHealthBuddy: 'NutriFlow در حال آماده‌سازی پیشنهاد شماست…',
    ...
    noFoods: 'هنوز داده غذایی دقیقی پیدا نشد، اما راهنمای مواد مغذی آماده است.',
    yourPlan: 'برنامه شما',
    bigRecommendation: 'پیشنهاد اصلی',
    photoHistoryTitle: 'سوابق اخیر',
    photoHistorySubtitle: 'تحلیل‌های غذایی در ۱۴ روز گذشته',
    ...
    welcomeEmptyText:
      'NutriFlow چک‌این شما را به مواد مغذی پشتیبان و یک قدم بعدی کاربردی تبدیل می‌کند.',
    diseases: {
...
const SCIENTIFIC_SOURCE_COPY: Record<Language, string> = {
  ...
  fa: 'منبع علمی: USDA FoodData Central و سازگاری محلی با هوش مصنوعی.',
};

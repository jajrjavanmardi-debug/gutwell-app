...
const copy = {
  ...
  de: {
    ...
    demoMealHelper: 'Beispielbilder laufen durch denselben Analysefluss wie Galerie-Uploads.',
  ...
  fa: {
    ...
    demoMealHelper: 'تصاویر نمونه مانند بارگذاری از گالری وارد همان جریان تحلیل غذا می شوند.',
    ...
    expoGoTextOnlyHint:
      'ورودی صوتی در این پیش نمایش در دسترس نیست. غذا و علائم خود را در کادر متن بنویسید؛ تحلیل چهار مرحله ای همچنان کار می کند.',
  },
} as const;
